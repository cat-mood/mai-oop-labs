...
Orc::Orc(int x, int y) : NPC{ORC, std::make_pair(x, y), RangeMove::ATTACK_RANGE_ORC, RangeMove::MOVE_RANGE_ORC} {}
...
bool VisitorOrc::visit(const std::shared_ptr<KnightErrant>& defender) {
    return false;
}
